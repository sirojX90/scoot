      ...
      <section className="px-[165px] py-[60px]">
        ...
        <div className="flex justify-between gap-[30px]">
          <div className="w-[30%]">
            <div className="relative flex flex-col items-center">
              ...
              <div className="absolute bottom-[-48px] flex justify-center items-center w-[96px] h-[96px] bg-yellow rounded-[50%]">
                <span className="text-[24px] dark:text-white text-darkNavy font-bold font-[SpaceMono]">
                  01
                </span>
              </div>
            </div>
            <h6 className="dark:text-white text-center mt-[80px]">Our tech</h6>
          ...
          <div className="w-[30%]">
            ...
            <h4 className="text-[24px] dark:text-white text-darkNavy text-center font-bold font-[SpaceMono] mt-[80px]">
              Our tech
            </h4>
        ...
        <div className="flex flex-col gap-[25px] my-[120px]">
          <div className="flex justify-between items-center dark:bg-gray-700 dark:border-2 bg-[#F2F5F9] py-[35px] px-[40px]">
            <div>
              <h6 className="text-[24px] text-darkNavy font-bold font-[SpaceMono]">
                General Manager
              </h6>
