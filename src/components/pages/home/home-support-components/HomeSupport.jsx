...
export const HomeSupport = () => {
  return (
    <div className="container">
      <section className="flex flex-col gap-[150px] sm:gap-[100px] px-[165px] sm:px-[32px] pt-[100px] pb-[200px]">
        <div className="flex sm:flex-wrap-reverse justify-between items-center">
          <div className="w-[50%] sm:w-[100%]">
            <h3 className="text-[48px] sm:text-[32px] sm:text-center sm:mt-[55px] sm:mb-[32px] text-[#495567] font-bold font-[SpaceMono]">
              Easy to use<br />
              riding telemetry
            </h3>
            <p className="text-[15px] text-[grey] sm:text-center font-normal font-[LexendDeca] mt-[25px] sm:mt-0 mb-[40px] sm:mb-[32px]">
        ...
        <div className="flex sm:flex-col justify-between items-center">
          ...
          <div className="w-[50%] sm:w-[100%]">
            <h3 className="text-[48px] sm:text-[32px] sm:text-center sm:mt-[55px] sm:mb-[32px] text-[#495567] font-bold font-[SpaceMono]">Coming to a city <br /> near you</h3>
            <p className="text-[15px] text-[grey] sm:text-center font-normal font-[LexendDeca] mt-[25px] sm:mt-0 mb-[40px] sm:mb-[32px]">
        ...
        <div className="flex sm:flex-wrap-reverse justify-between items-center">
          <div className="w-[50%] sm:w-[100%]">
            <h3 className="text-[48px] sm:text-[32px] sm:text-center sm:mt-[55px] sm:mb-[32px] text-[#495567] font-bold font-[SpaceMono]">Zero hassle <br /> payments</h3>
            <p className="text-[15px] text-[grey] sm:text-center font-normal font-[LexendDeca] mt-[25px] sm:mt-0 mb-[40px] sm:mb-[32px]">
