  ...
  return (
    <div className="container">
      <section className="px-[165px] py-[60px]">
        <h2 className="text-[56px] text-darkNavy text-center font-bold font-[SpaceMono] mb-[90px]">Our values</h2>
        <div className="flex justify-between gap-[30px]">
          <div className="w-[30%]">
            ...
            <h4 className="text-[24px] text-darkNavy text-center font-bold font-[SpaceMono] mt-[80px]">Our tech</h4>
